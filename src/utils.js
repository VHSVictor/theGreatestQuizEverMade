...
const getAnswersQuestions = () => {
    return [
        ...
        },
        {
            ...
            respostas:[{resposta: "Eu pratico exercícios físicos regularmente", option: BOM} ,{resposta: "Por questões econômicas (dinheiro)", option:RUIM}, {resposta: "Não tenho tempo (Ruim)", option:RUIM}, {resposta: "Não tenho vontade (Ruim)", option:RUIM}, {resposta : "Outro motivo (Ruim)", option:RUIM}],
            tipo: "atividade"
        },
        {
